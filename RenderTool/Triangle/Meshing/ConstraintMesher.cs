...
namespace TriangleNet.Meshing
{
    ...
    public class ConstraintMesher
    {
        ...
        private FindDirectionResult FindDirection(ref Otri searchtri, Vertex searchpoint)
        {
            ...
            while (leftflag)
            {
                if (loopCounter > 5000) throw new TriangleLoopCounterExecption();
                loopCounter++;
        ...
        public static int MaxScoutCounter = 0;
        ...
        {
            if (ScoutCounter > 5000) throw new TriangleException("over 5000");
            ScoutCounter++;
            MaxScoutCounter = Math.Max(MaxScoutCounter, ScoutCounter);
    ...
    public class TriangleLoopCounterExecption : TriangleException
    {
        public TriangleLoopCounterExecption() : base("loop counter exceeded")
        {
